...
**9개 분류의 완성형 프롬프트 76개, 독창적인 시작 프레임 사례 6개, 작성자가 공개한 프롬프트와 연결된 결과를 담았습니다.**
...
[카테고리별 탐색](#prompt-collections) · [바로 복사할 수 있는 예시 6개](#source-examples) · [공식 및 커뮤니티 생성 결과](#video-studies) · [전체 프롬프트 76개 색인](docs/prompt-index.md) · [전체 프롬프트 텍스트 다운로드](prompts/copy/all-prompts.txt)
...
<table width="100%">
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/cinematic-storytelling.md">영화와 스토리텔링</a></strong><br><br><a href="prompts/cinematic-storytelling.md"><img src="assets/showcase-v2-01.png" alt="영화와 스토리텔링" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/cinematic-storytelling.md#case-index">보기</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/commerce-social.md">광고와 소셜 미디어</a></strong><br><br><a href="prompts/commerce-social.md"><img src="assets/showcase-v2-02.png" alt="광고와 소셜 미디어" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/commerce-social.md#case-index">보기</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/documentary-education.md">다큐멘터리·여행·교육</a></strong><br><br><a href="prompts/documentary-education.md"><img src="assets/showcase-v2-03.png" alt="다큐멘터리·여행·교육" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/documentary-education.md#case-index">보기</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/stylized-entertainment.md">애니메이션·음악·엔터테인먼트</a></strong><br><br><a href="prompts/stylized-entertainment.md"><img src="assets/showcase-v2-04.png" alt="애니메이션·음악·엔터테인먼트" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/stylized-entertainment.md#case-index">보기</a></td>
...
<td width="33%" align="center" valign="top"><strong><a href="prompts/tactile-asmr.md">촉감과 ASMR</a></strong><br><br><a href="prompts/tactile-asmr.md"><img src="assets/showcase-v2-05.png" alt="촉감과 ASMR" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/tactile-asmr.md#case-index">보기</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/miniature-worlds.md">미니어처와 상상 속 세계</a></strong><br><br><a href="prompts/miniature-worlds.md"><img src="assets/showcase-v2-06.png" alt="미니어처와 상상 속 세계" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/miniature-worlds.md#case-index">보기</a></td>
</tr>
</table>

분류 이미지는 주제를 보여 주는 예시이며, 여섯 사례 이미지는 시작 프레임용 참조입니다. 둘 다 생성된 영상 결과가 아닙니다.
...
[01 · 비 내리는 세탁소의 무중력](#example-01) · [02 · 호박빛 향수와 기계식 일식](#example-02) · [03 · 맹그로브 수면 아래로](#example-03) · [04 · 종이 여우 우체부의 마지막 열차](#example-04) · [05 · 호박색 유리 배 속 별 모양 결정](#example-05) · [06 · 여행 가방 속 천문대](#example-06)
