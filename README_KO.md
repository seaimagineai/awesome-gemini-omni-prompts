...
**9개 분류의 완성형 프롬프트 76개, 독창적인 시작 프레임 사례 9개, 작성자가 공개한 프롬프트와 연결된 결과를 담았습니다.**
...
[카테고리별 탐색](#prompt-collections) · [바로 복사할 수 있는 예시 9개](#source-examples) · [공식 및 커뮤니티 생성 결과](#video-studies) · [전체 프롬프트 76개 색인](docs/prompt-index.md) · [전체 프롬프트 텍스트 다운로드](prompts/copy/all-prompts.txt)
...
<table width="100%">
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/cinematic-storytelling.md">영화와 스토리텔링</a></strong><br><br><a href="prompts/cinematic-storytelling.md"><img src="assets/category-cinema-v3.png" alt="영화와 스토리텔링" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/cinematic-storytelling.md#case-index">보기</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/commerce-social.md">광고와 소셜 미디어</a></strong><br><br><a href="prompts/commerce-social.md"><img src="assets/category-commerce-v3.png" alt="광고와 소셜 미디어" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/commerce-social.md#case-index">보기</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/documentary-education.md">다큐멘터리·여행·교육</a></strong><br><br><a href="prompts/documentary-education.md"><img src="assets/category-documentary-v3.png" alt="다큐멘터리·여행·교육" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/documentary-education.md#case-index">보기</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/stylized-entertainment.md">애니메이션·음악·엔터테인먼트</a></strong><br><br><a href="prompts/stylized-entertainment.md"><img src="assets/category-animation-v3.png" alt="애니메이션·음악·엔터테인먼트" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/stylized-entertainment.md#case-index">보기</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/control-editing-extension.md">멀티모달 제어·편집·연장</a></strong><br><br><a href="prompts/control-editing-extension.md"><img src="assets/category-control-v2.png" alt="멀티모달 제어·편집·연장" width="100%"></a><br>10 개 프롬프트<br><a href="prompts/control-editing-extension.md#case-index">보기</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/advanced-editing-camera.md">고급 편집·카메라·시각 변환</a></strong><br><br><a href="prompts/advanced-editing-camera.md"><img src="assets/category-camera-v2.png" alt="고급 편집·카메라·시각 변환" width="100%"></a><br>9 개 프롬프트<br><a href="prompts/advanced-editing-camera.md#case-index">보기</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/storyboard-text-evaluation.md">스토리보드·텍스트·평가</a></strong><br><br><a href="prompts/storyboard-text-evaluation.md"><img src="assets/category-storyboard-v2.png" alt="스토리보드·텍스트·평가" width="100%"></a><br>9 개 프롬프트<br><a href="prompts/storyboard-text-evaluation.md#case-index">보기</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/tactile-asmr.md">촉감과 ASMR</a></strong><br><br><a href="prompts/tactile-asmr.md"><img src="assets/category-asmr-v3.png" alt="촉감과 ASMR" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/tactile-asmr.md#case-index">보기</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/miniature-worlds.md">미니어처와 상상 속 세계</a></strong><br><br><a href="prompts/miniature-worlds.md"><img src="assets/category-miniature-v3.png" alt="미니어처와 상상 속 세계" width="100%"></a><br>8 개 프롬프트<br><a href="prompts/miniature-worlds.md#case-index">보기</a></td>
</tr>
</table>

분류 이미지는 주제를 보여 주는 예시이며, 아홉 사례 이미지는 시작 프레임용 참조입니다. 둘 다 생성된 영상 결과가 아닙니다.

[전체 프롬프트 76개 색인](docs/prompt-index.md) · [전체 프롬프트 텍스트 다운로드](prompts/copy/all-prompts.txt) · [새 분류의 창작 참고 출처](docs/public-prompt-sources.md#category-inspiration)

분류 설명은 현재 중국어와 영어로 제공하며, 복사할 수 있는 전체 프롬프트는 모두 영어입니다.

<a id="source-examples"></a>

## 바로 복사할 수 있는 예시 9개

참고 이미지는 입력용 자료이며 생성 결과가 아닙니다.

[01 · 비 내리는 세탁소의 무중력](#example-01) · [02 · 호박빛 향수와 기계식 일식](#example-02) · [03 · 맹그로브 수면 아래로](#example-03) · [04 · 종이 여우 우체부의 마지막 열차](#example-04) · [05 · 호박색 유리 배 속 별 모양 결정](#example-05) · [06 · 여행 가방 속 천문대](#example-06) · [07 · 서점의 창: 창밖만 겨울로](#example-07) · [08 · 운석 전시실: 한 번의 회전 촬영으로 드러나는 시차](#example-08) · [09 · 수중 유적: 빛의 씨앗을 돌려주는 로봇](#example-09)

<a id="example-01"></a>

### 01 · 비 내리는 세탁소의 무중력

[![비 내리는 세탁소의 무중력](assets/showcase-v2-01.png)](assets/showcase-v2-01.png)

[영화와 스토리텔링](prompts/cinematic-storytelling.md) · [첫 프레임 참고 이미지](assets/showcase-v2-01.png) · [일반 텍스트](prompts/copy/showcase-v2-01.txt)
...
[![호박빛 향수와 기계식 일식](assets/showcase-v2-02.png)](assets/showcase-v2-02.png)

[광고와 소셜 미디어](prompts/commerce-social.md) · [첫 프레임 참고 이미지](assets/showcase-v2-02.png) · [일반 텍스트](prompts/copy/showcase-v2-02.txt)
...
[![맹그로브 수면 아래로](assets/showcase-v2-03.png)](assets/showcase-v2-03.png)

[다큐멘터리·여행·교육](prompts/documentary-education.md) · [첫 프레임 참고 이미지](assets/showcase-v2-03.png) · [일반 텍스트](prompts/copy/showcase-v2-03.txt)
...
### 04 · 종이 여우 우체부의 마지막 열차

[![종이 여우 우체부의 마지막 열차](assets/showcase-v2-04.png)](assets/showcase-v2-04.png)

[애니메이션·음악·엔터테인먼트](prompts/stylized-entertainment.md) · [첫 프레임 참고 이미지](assets/showcase-v2-04.png) · [일반 텍스트](prompts/copy/showcase-v2-04.txt)
...
### 05 · 호박색 유리 배 속 별 모양 결정

[![호박색 유리 배 속 별 모양 결정](assets/showcase-v2-05.png)](assets/showcase-v2-05.png)

[촉감과 ASMR](prompts/tactile-asmr.md) · [첫 프레임 참고 이미지](assets/showcase-v2-05.png) · [일반 텍스트](prompts/copy/showcase-v2-05.txt)
...
[![여행 가방 속 천문대](assets/showcase-v2-06.png)](assets/showcase-v2-06.png)

[미니어처와 상상 속 세계](prompts/miniature-worlds.md) · [첫 프레임 참고 이미지](assets/showcase-v2-06.png) · [일반 텍스트](prompts/copy/showcase-v2-06.txt)
...
[![서점의 창: 창밖만 겨울로](assets/showcase-v3-07.png)](assets/showcase-v3-07.png)

[멀티모달 제어·편집·연장](prompts/control-editing-extension.md) · [첫 프레임 참고 이미지](assets/showcase-v3-07.png) · [일반 텍스트](prompts/copy/showcase-v3-07.txt)
...
### 08 · 운석 전시실: 한 번의 회전 촬영으로 드러나는 시차

[![운석 전시실: 한 번의 회전 촬영으로 드러나는 시차](assets/showcase-v3-08.png)](assets/showcase-v3-08.png)

[고급 편집·카메라·시각 변환](prompts/advanced-editing-camera.md) · [첫 프레임 참고 이미지](assets/showcase-v3-08.png) · [일반 텍스트](prompts/copy/showcase-v3-08.txt)
...
### 09 · 수중 유적: 빛의 씨앗을 돌려주는 로봇

[![수중 유적: 빛의 씨앗을 돌려주는 로봇](assets/showcase-v3-09.png)](assets/showcase-v3-09.png)

[스토리보드·텍스트·평가](prompts/storyboard-text-evaluation.md) · [첫 프레임 참고 이미지](assets/showcase-v3-09.png) · [일반 텍스트](prompts/copy/showcase-v3-09.txt)
...
모든 사례에 원본 프롬프트 링크가 있습니다. X 글은 미러로 확인했으며 원래 사이트의 재생은 확인하지 않았습니다. 모델 버전은 각 출처를 참고하세요. 이 저장소에서 재현한 결과가 아닙니다.

<table width="100%">
<tr>
<td width="50%" valign="top"><strong>비눗방울 조각</strong><br><a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm__omni__keynote__orb-structural-foam__260517_1.mp4"><img src="assets/official-bubbles-link.svg" alt="공식 영상 · 미리보기 이미지 없음" width="100%"></a><br>Google · Omni / Flash · 2026-05<br>입력 영상 필요<br><strong>공개 프롬프트 발췌</strong><blockquote>Make the sculpture out of bubbles.</blockquote><a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">작성자의 공개 프롬프트</a> · <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm__omni__keynote__orb-structural-foam__260517_1.mp4">영상 보기</a> · <a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">출처</a></td>
<td width="50%" valign="top"><strong>유리 구 속에서 반복되는 방</strong><br><a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm_omni__keynote__sizzle__hand-infinite-orbs__260517_1.mp4"><img src="assets/official-recursive-link.svg" alt="공식 영상 · 미리보기 이미지 없음" width="100%"></a><br>Google · Omni / Flash · 2026-05<br>입력 영상 필요<br><strong>공개 프롬프트 발췌</strong><blockquote>Put a black and white checkerboard room inside a glass sphere</blockquote><a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">작성자의 공개 프롬프트</a> · <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm_omni__keynote__sizzle__hand-infinite-orbs__260517_1.mp4">영상 보기</a> · <a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">출처</a></td>
</tr>
<tr>
<td width="50%" valign="top"><strong>사람을 홍학으로 바꾸기</strong><br><a href="https://video.twimg.com/amplify_video/2056797343085969408/vid/avc1/1080x1440/UYr_7RKomiginRgq.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056797343085969408/img/o5L2FQvozlZtiFsK.jpg" alt="사람을 홍학으로 바꾸기" width="100%"></a><br>CHRIS FIRST · Omni / Flash · 2026-05<br>입력 영상 필요<br><strong>공개 프롬프트 발췌</strong><blockquote>Make everyone in this shot flamingos. Wearing the same outfit.</blockquote><a href="https://x.com/chrisfirst/status/2056797606509158681">작성자의 공개 프롬프트</a> · <a href="https://video.twimg.com/amplify_video/2056797343085969408/vid/avc1/1080x1440/UYr_7RKomiginRgq.mp4?tag=27">영상 보기</a> · <a href="https://x.com/chrisfirst/status/2056797606509158681">출처</a></td>
<td width="50%" valign="top"><strong>박수칠 때마다 모자 바꾸기</strong><br><a href="https://video.twimg.com/amplify_video/2056793760273686528/vid/avc1/720x1280/Q73liRfIjPtGSveL.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056793760273686528/img/tZQnlGWzgr5wOwnM.jpg" alt="박수칠 때마다 모자 바꾸기" width="100%"></a><br>Justine Moore · Omni / Flash · 2026-05<br>입력 영상 필요<br><strong>공개 프롬프트 발췌</strong><blockquote>change my hat every time I clap.</blockquote><a href="https://x.com/venturetwins/status/2056793856843366789">작성자의 공개 프롬프트</a> · <a href="https://video.twimg.com/amplify_video/2056793760273686528/vid/avc1/720x1280/Q73liRfIjPtGSveL.mp4?tag=27">영상 보기</a> · <a href="https://x.com/venturetwins/status/2056793856843366789">출처</a></td>
</tr>
<tr>
<td width="50%" valign="top"><strong>런던 아이에서 핸드헬드 줌</strong><br><a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056503814874861569/img/mQnHwThYDypoS1H6.jpg" alt="런던 아이에서 핸드헬드 줌" width="100%"></a><br>fofr · Omni / Flash · 2026-05<br>텍스트로 영상 만들기<br><strong>공개 프롬프트 발췌</strong><blockquote>a recording from a capsule on the london eye, a jerky zoom into something in the distance</blockquote><a href="https://x.com/fofrAI/status/2056789242274259242">작성자의 공개 프롬프트</a> · <a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27">영상 보기</a> · <a href="https://x.com/fofrAI/status/2056789242274259242">출처</a></td>
<td width="50%" valign="top"><strong>손이 닿으면 물병 재질 바꾸기</strong><br><a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2057176000459612161/img/wTZ0HcgL_8PHxwbY.jpg" alt="손이 닿으면 물병 재질 바꾸기" width="100%"></a><br>Alexander Chen · Omni / Flash · 2026-05<br>입력 영상 필요<br><strong>공개 프롬프트 발췌</strong><blockquote>make the material of the pitcher instantly change (hard cuts) every 1 seconds to a new material</blockquote><a href="https://x.com/alexanderchen/status/2057176691903279524">작성자의 공개 프롬프트</a> · <a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27">영상 보기</a> · <a href="https://x.com/alexanderchen/status/2057176690519089166">출처</a></td>
</tr>
</table>

[출처 / FxTwitter](docs/public-prompt-sources.md)

## 심화 문서

기본 사용법을 아는 분이라면 참조 자료의 역할, 동작 타이밍, 한 번에 하나의 변경에 집중하세요.

1. 물체 수, 위치, 초기 상태가 시작 프레임과 맞도록 프롬프트를 조정하세요.
2. 시간 구간마다 주요 동작 하나를 배치하고 소리를 화면 속 동작과 맞추세요.
3. 주인공은 유지하고 카메라나 재질만 바꾸며, 선택한 모델의 실제 지원 길이에 맞춰 시간을 조정하세요.

바로 쓸 수 있는 단일 변경 지시문 — 선택한 모델이 편집을 지원하는 경우
...
[심화 문서](docs/guides/README_KO.md)

[프롬프트 설계](docs/prompting-guide.md) · [다국어 안내](docs/multilingual-guide.md) · [참고 자료와 이용 허락](docs/reference-videos.md)
...
1. 시작 이미지를 내려받아 이미지로 영상 만들기에 업로드하고 전체 프롬프트를 붙여 넣으세요.
2. 모델이 제공하는 길이, 화면 비율, 해상도를 선택해 먼저 초안을 만드세요.
3. 구도가 마음에 들면 한 번에 세부 사항 하나씩 조정한 후 해상도를 높이세요.

[Gemini Omni 1.1 Flash](https://seaimagine.com/ko/model/gemini-omni-1-1-flash/) · [Gemini Omni](https://seaimagine.com/ko/model/gemini-omni/)

[이미지로 영상 만들기](https://seaimagine.com/ko/image-to-video/) · [텍스트로 영상 만들기](https://seaimagine.com/ko/text-to-video/) · [AI 이미지 생성기](https://seaimagine.com/ko/ai-image-generator/)
