...
**76 prompt lengkap dalam 9 kategori, 6 contoh dengan bingkai awal orisinal, serta hasil dengan tautan prompt yang dipublikasikan pembuatnya.**
...
[Jelajahi berdasarkan kategori](#prompt-collections) · [Enam contoh siap salin](#source-examples) · [Hasil resmi dan komunitas](#video-studies) · [Indeks seluruh 76 prompt](docs/prompt-index.md) · [Unduh semua prompt sebagai teks](prompts/copy/all-prompts.txt)
...
<table width="100%">
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/cinematic-storytelling.md">Film dan cerita</a></strong><br><br><a href="prompts/cinematic-storytelling.md"><img src="assets/showcase-v2-01.png" alt="Film dan cerita" width="100%"></a><br>8 prompt<br><a href="prompts/cinematic-storytelling.md#case-index">Lihat</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/commerce-social.md">Iklan dan media sosial</a></strong><br><br><a href="prompts/commerce-social.md"><img src="assets/showcase-v2-02.png" alt="Iklan dan media sosial" width="100%"></a><br>8 prompt<br><a href="prompts/commerce-social.md#case-index">Lihat</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/documentary-education.md">Dokumenter, perjalanan dan pendidikan</a></strong><br><br><a href="prompts/documentary-education.md"><img src="assets/showcase-v2-03.png" alt="Dokumenter, perjalanan dan pendidikan" width="100%"></a><br>8 prompt<br><a href="prompts/documentary-education.md#case-index">Lihat</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/stylized-entertainment.md">Animasi, musik dan hiburan</a></strong><br><br><a href="prompts/stylized-entertainment.md"><img src="assets/showcase-v2-04.png" alt="Animasi, musik dan hiburan" width="100%"></a><br>8 prompt<br><a href="prompts/stylized-entertainment.md#case-index">Lihat</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/control-editing-extension.md">Kontrol multimodal, penyuntingan dan perpanjangan</a></strong><br><br><a href="prompts/control-editing-extension.md"><img src="assets/category-control-v2.png" alt="Kontrol multimodal, penyuntingan dan perpanjangan" width="100%"></a><br>10 prompt<br><a href="prompts/control-editing-extension.md#case-index">Lihat</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/advanced-editing-camera.md">Penyuntingan lanjutan, kamera dan transformasi visual</a></strong><br><br><a href="prompts/advanced-editing-camera.md"><img src="assets/category-camera-v2.png" alt="Penyuntingan lanjutan, kamera dan transformasi visual" width="100%"></a><br>9 prompt<br><a href="prompts/advanced-editing-camera.md#case-index">Lihat</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/storyboard-text-evaluation.md">Storyboard, teks dan evaluasi</a></strong><br><br><a href="prompts/storyboard-text-evaluation.md"><img src="assets/category-storyboard-v2.png" alt="Storyboard, teks dan evaluasi" width="100%"></a><br>9 prompt<br><a href="prompts/storyboard-text-evaluation.md#case-index">Lihat</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/tactile-asmr.md">Tekstur dan ASMR</a></strong><br><br><a href="prompts/tactile-asmr.md"><img src="assets/showcase-v2-05.png" alt="Tekstur dan ASMR" width="100%"></a><br>8 prompt<br><a href="prompts/tactile-asmr.md#case-index">Lihat</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/miniature-worlds.md">Dunia miniatur dan imajinasi</a></strong><br><br><a href="prompts/miniature-worlds.md"><img src="assets/showcase-v2-06.png" alt="Dunia miniatur dan imajinasi" width="100%"></a><br>8 prompt<br><a href="prompts/miniature-worlds.md#case-index">Lihat</a></td>
</tr>
</table>

Gambar kategori menggambarkan temanya. Keenam gambar contoh adalah referensi bingkai awal. Keduanya bukan hasil video yang telah dibuat.

[Indeks seluruh 76 prompt](docs/prompt-index.md) · [Unduh semua prompt sebagai teks](prompts/copy/all-prompts.txt) · [Sumber inspirasi kategori baru](docs/public-prompt-sources.md#category-inspiration)

Deskripsi kategori saat ini tersedia dalam bahasa Mandarin dan Inggris; semua prompt lengkap yang dapat disalin ditulis dalam bahasa Inggris.

<a id="source-examples"></a>

## Enam contoh siap salin

Gambar referensi merupakan bahan input, bukan hasil generasi.

[01 · Gravitasi hilang di tempat penatu](#example-01) · [02 · Parfum ambar dan gerhana mekanis](#example-02) · [03 · Di bawah air hutan bakau](#example-03) · [04 · Rubah mengantar surat terakhir](#example-04) · [05 · Pir kaca ambar dengan inti bintang](#example-05) · [06 · Observatorium di dalam koper](#example-06)

<a id="example-01"></a>

### 01 · Gravitasi hilang di tempat penatu

[![Gravitasi hilang di tempat penatu](assets/showcase-v2-01.png)](assets/showcase-v2-01.png)

[Film dan cerita](prompts/cinematic-storytelling.md) · [Bingkai awal referensi](assets/showcase-v2-01.png) · [Teks biasa](prompts/copy/showcase-v2-01.txt)
...
### 02 · Parfum ambar dan gerhana mekanis

[![Parfum ambar dan gerhana mekanis](assets/showcase-v2-02.png)](assets/showcase-v2-02.png)

[Iklan dan media sosial](prompts/commerce-social.md) · [Bingkai awal referensi](assets/showcase-v2-02.png) · [Teks biasa](prompts/copy/showcase-v2-02.txt)
...
### 03 · Di bawah air hutan bakau

[![Di bawah air hutan bakau](assets/showcase-v2-03.png)](assets/showcase-v2-03.png)

[Dokumenter, perjalanan dan pendidikan](prompts/documentary-education.md) · [Bingkai awal referensi](assets/showcase-v2-03.png) · [Teks biasa](prompts/copy/showcase-v2-03.txt)
...
### 04 · Rubah mengantar surat terakhir

[![Rubah mengantar surat terakhir](assets/showcase-v2-04.png)](assets/showcase-v2-04.png)

[Animasi, musik dan hiburan](prompts/stylized-entertainment.md) · [Bingkai awal referensi](assets/showcase-v2-04.png) · [Teks biasa](prompts/copy/showcase-v2-04.txt)
...
### 05 · Pir kaca ambar dengan inti bintang

[![Pir kaca ambar dengan inti bintang](assets/showcase-v2-05.png)](assets/showcase-v2-05.png)

[Tekstur dan ASMR](prompts/tactile-asmr.md) · [Bingkai awal referensi](assets/showcase-v2-05.png) · [Teks biasa](prompts/copy/showcase-v2-05.txt)
...
### 06 · Observatorium di dalam koper

[![Observatorium di dalam koper](assets/showcase-v2-06.png)](assets/showcase-v2-06.png)

[Dunia miniatur dan imajinasi](prompts/miniature-worlds.md) · [Bingkai awal referensi](assets/showcase-v2-06.png) · [Teks biasa](prompts/copy/showcase-v2-06.txt)
...
## Hasil resmi dan komunitas

Setiap hasil menautkan prompt asli. Teks X diperiksa melalui mirror; pemutaran di X belum diverifikasi. Lihat versi model pada tiap sumber. Hasil ini tidak direproduksi oleh repositori ini.

<table width="100%">
<tr>
</tr>
<tr>
<td width="50%" valign="top"><strong>Zoom genggam dari London Eye</strong><br><a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056503814874861569/img/mQnHwThYDypoS1H6.jpg" alt="Zoom genggam dari London Eye" width="100%"></a><br>fofr · Omni / Flash · 2026-05<br>Teks ke video<br><strong>Kutipan prompt yang dipublikasikan</strong><blockquote>a recording from a capsule on the london eye, a jerky zoom into something in the distance</blockquote><a href="https://x.com/fofrAI/status/2056789242274259242">Prompt yang dipublikasikan pembuat</a> · <a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27">Tonton video</a> · <a href="https://x.com/fofrAI/status/2056789242274259242">Sumber</a></td>
<td width="50%" valign="top"><strong>Mengubah bahan teko saat disentuh</strong><br><a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2057176000459612161/img/wTZ0HcgL_8PHxwbY.jpg" alt="Mengubah bahan teko saat disentuh" width="100%"></a><br>Alexander Chen · Omni / Flash · 2026-05<br>Memerlukan video masukan<br><strong>Kutipan prompt yang dipublikasikan</strong><blockquote>make the material of the pitcher instantly change (hard cuts) every 1 seconds to a new material</blockquote><a href="https://x.com/alexanderchen/status/2057176691903279524">Prompt yang dipublikasikan pembuat</a> · <a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27">Tonton video</a> · <a href="https://x.com/alexanderchen/status/2057176690519089166">Sumber</a></td>
</tr>
</table>

[Sumber / FxTwitter](docs/public-prompt-sources.md)

## Dokumentasi lanjutan

Untuk pengguna berpengalaman: perjelas peran referensi, waktu gerakan, dan ubah satu hal setiap kali.

1. Samakan jumlah, posisi dan keadaan awal objek dengan bingkai pertama.
2. Tetapkan satu gerakan utama per rentang waktu dan selaraskan suara dengan pemicunya di layar.
3. Pertahankan subjek, ubah hanya kamera atau bahan, lalu sesuaikan waktunya dengan durasi yang didukung model.

Instruksi siap pakai untuk satu perubahan, jika model mendukung penyuntingan
...
[Dokumentasi lanjutan](docs/guides/README_ID.md)

[Perancangan prompt](docs/prompting-guide.md) · [Panduan multibahasa](docs/multilingual-guide.md) · [Referensi dan izin](docs/reference-videos.md)
...
1. Unduh bingkai awal, unggah ke fitur gambar ke video, lalu tempel prompt lengkap.
2. Pilih durasi, rasio dan resolusi yang tersedia pada model; buat draf dahulu.
3. Setelah komposisinya sesuai, ubah satu detail setiap kali sebelum menaikkan resolusi.

[Gemini Omni 1.1 Flash](https://seaimagine.com/id/model/gemini-omni-1-1-flash/) · [Gemini Omni](https://seaimagine.com/id/model/gemini-omni/)

[Gambar ke video](https://seaimagine.com/id/image-to-video/) · [Teks ke video](https://seaimagine.com/id/text-to-video/) · [Generator gambar AI](https://seaimagine.com/id/ai-image-generator/)
