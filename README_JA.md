...
**9 カテゴリ・76 本の完全版プロンプト、6 つのオリジナル開始フレーム例、作者が公開したプロンプト付きの生成結果を収録。**
...
[カテゴリから探す](#prompt-collections) · [そのままコピーできる 6 つの例](#source-examples) · [公式・コミュニティの生成例](#video-studies) · [全 76 件のプロンプト一覧](docs/prompt-index.md) · [全プロンプトをテキストでダウンロード](prompts/copy/all-prompts.txt)
...
<table width="100%">
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/cinematic-storytelling.md">映画・ストーリー</a></strong><br><br><a href="prompts/cinematic-storytelling.md"><img src="assets/showcase-v2-01.png" alt="映画・ストーリー" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/cinematic-storytelling.md#case-index">表示</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/commerce-social.md">広告・SNS</a></strong><br><br><a href="prompts/commerce-social.md"><img src="assets/showcase-v2-02.png" alt="広告・SNS" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/commerce-social.md#case-index">表示</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/documentary-education.md">ドキュメンタリー・旅行・教育</a></strong><br><br><a href="prompts/documentary-education.md"><img src="assets/showcase-v2-03.png" alt="ドキュメンタリー・旅行・教育" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/documentary-education.md#case-index">表示</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/stylized-entertainment.md">アニメーション・音楽・娯楽</a></strong><br><br><a href="prompts/stylized-entertainment.md"><img src="assets/showcase-v2-04.png" alt="アニメーション・音楽・娯楽" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/stylized-entertainment.md#case-index">表示</a></td>
...
<td width="33%" align="center" valign="top"><strong><a href="prompts/tactile-asmr.md">触感と ASMR</a></strong><br><br><a href="prompts/tactile-asmr.md"><img src="assets/showcase-v2-05.png" alt="触感と ASMR" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/tactile-asmr.md#case-index">表示</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/miniature-worlds.md">ミニチュア・空想世界</a></strong><br><br><a href="prompts/miniature-worlds.md"><img src="assets/showcase-v2-06.png" alt="ミニチュア・空想世界" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/miniature-worlds.md#case-index">表示</a></td>
</tr>
</table>

カテゴリ画像は題材のイメージです。6 つの作例画像は開始フレーム用の参照画像です。いずれも生成動画の結果ではありません。
...
[01 · 雨のコインランドリーで重力が消える](#example-01) · [02 · 琥珀の香水と機械仕掛けの日食](#example-02) · [03 · マングローブの水面下へ](#example-03) · [04 · 折り紙のキツネと最終列車](#example-04) · [05 · 琥珀ガラスの洋梨と星形の芯](#example-05) · [06 · スーツケースの中の天文台](#example-06)
