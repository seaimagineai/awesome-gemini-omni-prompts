...
**9 カテゴリ・76 本の完全版プロンプト、9 つのオリジナル開始フレーム例、作者が公開したプロンプト付きの生成結果を収録。**
...
[カテゴリから探す](#prompt-collections) · [そのままコピーできる 9 つの例](#source-examples) · [公式・コミュニティの生成例](#video-studies) · [全 76 件のプロンプト一覧](docs/prompt-index.md) · [全プロンプトをテキストでダウンロード](prompts/copy/all-prompts.txt)
...
<table width="100%">
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/cinematic-storytelling.md">映画・ストーリー</a></strong><br><br><a href="prompts/cinematic-storytelling.md"><img src="assets/category-cinema-v3.png" alt="映画・ストーリー" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/cinematic-storytelling.md#case-index">表示</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/commerce-social.md">広告・SNS</a></strong><br><br><a href="prompts/commerce-social.md"><img src="assets/category-commerce-v3.png" alt="広告・SNS" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/commerce-social.md#case-index">表示</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/documentary-education.md">ドキュメンタリー・旅行・教育</a></strong><br><br><a href="prompts/documentary-education.md"><img src="assets/category-documentary-v3.png" alt="ドキュメンタリー・旅行・教育" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/documentary-education.md#case-index">表示</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/stylized-entertainment.md">アニメーション・音楽・娯楽</a></strong><br><br><a href="prompts/stylized-entertainment.md"><img src="assets/category-animation-v3.png" alt="アニメーション・音楽・娯楽" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/stylized-entertainment.md#case-index">表示</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/control-editing-extension.md">マルチモーダル制御・編集・延長</a></strong><br><br><a href="prompts/control-editing-extension.md"><img src="assets/category-control-v2.png" alt="マルチモーダル制御・編集・延長" width="100%"></a><br>10 本のプロンプト<br><a href="prompts/control-editing-extension.md#case-index">表示</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/advanced-editing-camera.md">高度な編集・カメラ・視覚変換</a></strong><br><br><a href="prompts/advanced-editing-camera.md"><img src="assets/category-camera-v2.png" alt="高度な編集・カメラ・視覚変換" width="100%"></a><br>9 本のプロンプト<br><a href="prompts/advanced-editing-camera.md#case-index">表示</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/storyboard-text-evaluation.md">絵コンテ・文字・評価</a></strong><br><br><a href="prompts/storyboard-text-evaluation.md"><img src="assets/category-storyboard-v2.png" alt="絵コンテ・文字・評価" width="100%"></a><br>9 本のプロンプト<br><a href="prompts/storyboard-text-evaluation.md#case-index">表示</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/tactile-asmr.md">触感と ASMR</a></strong><br><br><a href="prompts/tactile-asmr.md"><img src="assets/category-asmr-v3.png" alt="触感と ASMR" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/tactile-asmr.md#case-index">表示</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/miniature-worlds.md">ミニチュア・空想世界</a></strong><br><br><a href="prompts/miniature-worlds.md"><img src="assets/category-miniature-v3.png" alt="ミニチュア・空想世界" width="100%"></a><br>8 本のプロンプト<br><a href="prompts/miniature-worlds.md#case-index">表示</a></td>
</tr>
</table>

カテゴリ画像は題材のイメージです。9 つの作例画像は開始フレーム用の参照画像です。いずれも生成動画の結果ではありません。

[全 76 件のプロンプト一覧](docs/prompt-index.md) · [全プロンプトをテキストでダウンロード](prompts/copy/all-prompts.txt) · [新カテゴリの着想元](docs/public-prompt-sources.md#category-inspiration)

カテゴリの解説は現在、中国語と英語で掲載しています。コピーできる完全版プロンプトはすべて英語です。
...
[01 · 雨のコインランドリーで重力が消える](#example-01) · [02 · 琥珀の香水と機械仕掛けの日食](#example-02) · [03 · マングローブの水面下へ](#example-03) · [04 · 折り紙のキツネと最終列車](#example-04) · [05 · 琥珀ガラスの洋梨と星形の芯](#example-05) · [06 · スーツケースの中の天文台](#example-06) · [07 · 書店の窓：窓の外だけが冬になる](#example-07) · [08 · 隕石の展示室：回り込むカメラと視差](#example-08) · [09 · 水中遺跡：ロボットが光の種を返す](#example-09)

<a id="example-01"></a>

### 01 · 雨のコインランドリーで重力が消える

[![雨のコインランドリーで重力が消える](assets/showcase-v2-01.png)](assets/showcase-v2-01.png)

[映画・ストーリー](prompts/cinematic-storytelling.md) · [開始フレーム用の参考画像](assets/showcase-v2-01.png) · [プレーンテキスト](prompts/copy/showcase-v2-01.txt)
...
[![琥珀の香水と機械仕掛けの日食](assets/showcase-v2-02.png)](assets/showcase-v2-02.png)

[広告・SNS](prompts/commerce-social.md) · [開始フレーム用の参考画像](assets/showcase-v2-02.png) · [プレーンテキスト](prompts/copy/showcase-v2-02.txt)
...
[![マングローブの水面下へ](assets/showcase-v2-03.png)](assets/showcase-v2-03.png)

[ドキュメンタリー・旅行・教育](prompts/documentary-education.md) · [開始フレーム用の参考画像](assets/showcase-v2-03.png) · [プレーンテキスト](prompts/copy/showcase-v2-03.txt)
...
[![折り紙のキツネと最終列車](assets/showcase-v2-04.png)](assets/showcase-v2-04.png)

[アニメーション・音楽・娯楽](prompts/stylized-entertainment.md) · [開始フレーム用の参考画像](assets/showcase-v2-04.png) · [プレーンテキスト](prompts/copy/showcase-v2-04.txt)
...
[![琥珀ガラスの洋梨と星形の芯](assets/showcase-v2-05.png)](assets/showcase-v2-05.png)

[触感と ASMR](prompts/tactile-asmr.md) · [開始フレーム用の参考画像](assets/showcase-v2-05.png) · [プレーンテキスト](prompts/copy/showcase-v2-05.txt)
...
[![スーツケースの中の天文台](assets/showcase-v2-06.png)](assets/showcase-v2-06.png)

[ミニチュア・空想世界](prompts/miniature-worlds.md) · [開始フレーム用の参考画像](assets/showcase-v2-06.png) · [プレーンテキスト](prompts/copy/showcase-v2-06.txt)
...
[![書店の窓：窓の外だけが冬になる](assets/showcase-v3-07.png)](assets/showcase-v3-07.png)

[マルチモーダル制御・編集・延長](prompts/control-editing-extension.md) · [開始フレーム用の参考画像](assets/showcase-v3-07.png) · [プレーンテキスト](prompts/copy/showcase-v3-07.txt)
...
### 08 · 隕石の展示室：回り込むカメラと視差

[![隕石の展示室：回り込むカメラと視差](assets/showcase-v3-08.png)](assets/showcase-v3-08.png)

[高度な編集・カメラ・視覚変換](prompts/advanced-editing-camera.md) · [開始フレーム用の参考画像](assets/showcase-v3-08.png) · [プレーンテキスト](prompts/copy/showcase-v3-08.txt)
...
[![水中遺跡：ロボットが光の種を返す](assets/showcase-v3-09.png)](assets/showcase-v3-09.png)

[絵コンテ・文字・評価](prompts/storyboard-text-evaluation.md) · [開始フレーム用の参考画像](assets/showcase-v3-09.png) · [プレーンテキスト](prompts/copy/showcase-v3-09.txt)
...
全例に元のプロンプトへのリンクがあります。X の文章はミラーで確認し、元サイトの再生は未確認です。モデルのバージョンは各出典を参照してください。本リポジトリによる再現結果ではありません。

<table width="100%">
<tr>
<td width="50%" valign="top"><strong>泡の彫刻</strong><br><a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm__omni__keynote__orb-structural-foam__260517_1.mp4"><img src="assets/official-bubbles-link.svg" alt="公式動画・サムネイルなし" width="100%"></a><br>Google · Omni / Flash · 2026-05<br>入力動画が必要<br><strong>公開プロンプトの抜粋</strong><blockquote>Make the sculpture out of bubbles.</blockquote><a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">作者の公開プロンプト</a> · <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm__omni__keynote__orb-structural-foam__260517_1.mp4">動画を見る</a> · <a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">出典</a></td>
<td width="50%" valign="top"><strong>ガラス球の中で繰り返す部屋</strong><br><a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm_omni__keynote__sizzle__hand-infinite-orbs__260517_1.mp4"><img src="assets/official-recursive-link.svg" alt="公式動画・サムネイルなし" width="100%"></a><br>Google · Omni / Flash · 2026-05<br>入力動画が必要<br><strong>公開プロンプトの抜粋</strong><blockquote>Put a black and white checkerboard room inside a glass sphere</blockquote><a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">作者の公開プロンプト</a> · <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm_omni__keynote__sizzle__hand-infinite-orbs__260517_1.mp4">動画を見る</a> · <a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">出典</a></td>
</tr>
<tr>
<td width="50%" valign="top"><strong>人物をフラミンゴに変える</strong><br><a href="https://video.twimg.com/amplify_video/2056797343085969408/vid/avc1/1080x1440/UYr_7RKomiginRgq.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056797343085969408/img/o5L2FQvozlZtiFsK.jpg" alt="人物をフラミンゴに変える" width="100%"></a><br>CHRIS FIRST · Omni / Flash · 2026-05<br>入力動画が必要<br><strong>公開プロンプトの抜粋</strong><blockquote>Make everyone in this shot flamingos. Wearing the same outfit.</blockquote><a href="https://x.com/chrisfirst/status/2056797606509158681">作者の公開プロンプト</a> · <a href="https://video.twimg.com/amplify_video/2056797343085969408/vid/avc1/1080x1440/UYr_7RKomiginRgq.mp4?tag=27">動画を見る</a> · <a href="https://x.com/chrisfirst/status/2056797606509158681">出典</a></td>
<td width="50%" valign="top"><strong>拍手のたびに帽子を変える</strong><br><a href="https://video.twimg.com/amplify_video/2056793760273686528/vid/avc1/720x1280/Q73liRfIjPtGSveL.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056793760273686528/img/tZQnlGWzgr5wOwnM.jpg" alt="拍手のたびに帽子を変える" width="100%"></a><br>Justine Moore · Omni / Flash · 2026-05<br>入力動画が必要<br><strong>公開プロンプトの抜粋</strong><blockquote>change my hat every time I clap.</blockquote><a href="https://x.com/venturetwins/status/2056793856843366789">作者の公開プロンプト</a> · <a href="https://video.twimg.com/amplify_video/2056793760273686528/vid/avc1/720x1280/Q73liRfIjPtGSveL.mp4?tag=27">動画を見る</a> · <a href="https://x.com/venturetwins/status/2056793856843366789">出典</a></td>
</tr>
<tr>
<td width="50%" valign="top"><strong>ロンドン・アイから手持ちズーム</strong><br><a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056503814874861569/img/mQnHwThYDypoS1H6.jpg" alt="ロンドン・アイから手持ちズーム" width="100%"></a><br>fofr · Omni / Flash · 2026-05<br>テキストから動画<br><strong>公開プロンプトの抜粋</strong><blockquote>a recording from a capsule on the london eye, a jerky zoom into something in the distance</blockquote><a href="https://x.com/fofrAI/status/2056789242274259242">作者の公開プロンプト</a> · <a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27">動画を見る</a> · <a href="https://x.com/fofrAI/status/2056789242274259242">出典</a></td>
<td width="50%" valign="top"><strong>触れるとピッチャーの材質が変わる</strong><br><a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2057176000459612161/img/wTZ0HcgL_8PHxwbY.jpg" alt="触れるとピッチャーの材質が変わる" width="100%"></a><br>Alexander Chen · Omni / Flash · 2026-05<br>入力動画が必要<br><strong>公開プロンプトの抜粋</strong><blockquote>make the material of the pitcher instantly change (hard cuts) every 1 seconds to a new material</blockquote><a href="https://x.com/alexanderchen/status/2057176691903279524">作者の公開プロンプト</a> · <a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27">動画を見る</a> · <a href="https://x.com/alexanderchen/status/2057176690519089166">出典</a></td>
</tr>
</table>

[出典 / FxTwitter](docs/public-prompt-sources.md)

## 詳しいドキュメント

基本操作に慣れている方向けに、参照素材の役割、動作のタイミング、部分的な変更を整理します。

1. 物の数・位置・初期状態を開始フレームに合わせます。
2. 各時間帯の主な動作を一つに絞り、音を画面上の動きに合わせます。
3. 被写体を保ったままカメラか材質だけを変更し、対応する動画の長さに合わせて時間配分を調整します。

そのまま使える単一変更の指示（選択したモデルが編集に対応している場合）
...
[詳しいドキュメント](docs/guides/README_JA.md)
...
1. 開始画像をダウンロードして画像から動画の機能にアップロードし、完全版プロンプトを貼り付けます。
2. 選んだモデルで利用できる長さ・縦横比・解像度を設定し、まず下書きを生成します。
3. 構図が決まったら一度に一つだけ調整し、その後で解像度を上げます。

[Gemini Omni 1.1 Flash](https://seaimagine.com/ja/model/gemini-omni-1-1-flash/) · [Gemini Omni](https://seaimagine.com/ja/model/gemini-omni/)
