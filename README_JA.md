...
[SeaImagine 独自の参考画像で試す3つの練習](#sea-practice) · [コピーして試す 3 例](#source-examples) · [公式・コミュニティ事例から学ぶ](#video-studies)
...
Google の動画は Omni 1.1 Flash の公式デモであり、SeaImagine の生成結果ではありません。コミュニティ事例は2026年5月の初代 Omni / Flash に関する投稿で、1.1 の実測とは確認できていません。証拠は FxTwitter の投稿文とメディア情報で、X 上の直接再生は未確認です。各機能の有無は SeaImagine で確認してください。

### Google：開始・終了フレームをつなぐ

[元の事例を見る](https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/sm_KW_omni-flash__capability-video__first-last-frame__16x9_1.mp4)
...
[元の事例を見る](https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/omni-flash__capability-video__extend-multi-cinematography__16x9_25YzzFv.mp4)
...
[元の事例を見る](https://x.com/chrisfirst/status/2056797606509158681)
...
[元の事例を見る](https://x.com/venturetwins/status/2056793856843366789)
...
以下はプロンプトで設計する内容です。利用できる入力、編集、延長、音声、解像度は SeaImagine の選択中のモデルと画面で確認してください。まず利用可能なプレビュー設定で構図・台詞・文字を確認し、その後に仕上げます。Google の API（プログラム用インターフェース）の仕様と SeaImagine の画面は別です。
