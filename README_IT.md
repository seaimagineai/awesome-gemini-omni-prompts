# Prompt video Gemini Omni per SeaImagine
...
[Tre esercizi SeaImagine con immagini originali](#sea-practice) · [Tre prompt da copiare](#source-examples) · [Cosa imparare dagli esempi ufficiali e della community](#video-studies)
...
I video di Google mostrano Omni 1.1 Flash, non risultati di SeaImagine. I post della community risalgono a maggio 2026 e riguardano Omni / Flash originale; non sono test confermati della versione 1.1. Le prove consultate sono testi e metadati di FxTwitter, senza verifica della riproduzione nativa su X. Controlla le funzioni in SeaImagine.

### Google: transizione tra fotogramma iniziale e finale

[Guarda l’esempio originale](https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/sm_KW_omni-flash__capability-video__first-last-frame__16x9_1.mp4)
...
[Guarda l’esempio originale](https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/omni-flash__capability-video__extend-multi-cinematography__16x9_25YzzFv.mp4)
...
[Guarda l’esempio originale](https://x.com/chrisfirst/status/2056797606509158681)
...
[Guarda l’esempio originale](https://x.com/venturetwins/status/2056793856843366789)
...
L’elenco descrive cosa pianificare nei prompt, senza garantire la disponibilità delle funzioni. Verifica input, modifica, estensione, audio e risoluzione nel modello scelto su SeaImagine. Controlla prima composizione, dialogo e testo con un’anteprima disponibile. L’API di Google (interfaccia di programmazione) è distinta dall’interfaccia di SeaImagine.
