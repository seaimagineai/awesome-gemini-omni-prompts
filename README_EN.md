...
**60 complete Gemini Omni video recipes across 7 collections, adapted from Flaq AI, with SeaImagine workflows and guides for all 15 website languages.**
...
## Three complete prompts to try first
...
## Learn from official and community videos

Watch the linked originals, then practice the technique with your own media. [Official demonstrations and X community case studies →](docs/community-examples.md). Each entry records its source and what was actually verified; creator clips are not SeaImagine output samples.


| Community preview · open original | Technique to study |
|---|---|
| [![Replace people with flamingos](https://pbs.twimg.com/amplify_video_thumb/2056797343085969408/img/o5L2FQvozlZtiFsK.jpg)](https://x.com/chrisfirst/status/2056797606509158681) | [Replace people with flamingos — CHRIS FIRST](https://x.com/chrisfirst/status/2056797606509158681). Lock clothing and the original action while changing the subject. Check limb contacts and costume continuity. |
| [![Change hats on each clap](https://pbs.twimg.com/amplify_video_thumb/2056793760273686528/img/tZQnlGWzgr5wOwnM.jpg)](https://x.com/venturetwins/status/2056793856843366789) | [Change hats on each clap — Justine Moore](https://x.com/venturetwins/status/2056793856843366789). Use a visible gesture to time an edit. Keep the face, outfit and camera fixed. |

These May 2026 Omni/Flash posts were quoted by Google AI. Author text and media metadata were checked through a third-party mirror; native playback and 1.1 Flash usage are not verified. [Evidence and six case studies](docs/community-examples.md).

### Two official 1.1 Flash studies

- [First/last-frame transition — Google video](https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/sm_KW_omni-flash__capability-video__first-last-frame__16x9_1.mp4): plan the two endpoints and the continuous camera move between them.
- [Cinematic extension — Google video](https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/omni-flash__capability-video__extend-multi-cinematography__16x9_25YzzFv.mp4): plan the next shot without rewriting the entire scene.

[Google's original announcement and context](https://blog.google/innovation-and-ai/technology/developers-tools/build-with-gemini-omni-1-1-flash/). Official demonstration links are for study; they are not SeaImagine output tests.
...
| Python, JavaScript, or REST integration | [Gemini API quickstart](docs/api-quickstart.md) |
...
- **3 ready-to-use reference images** from the source library, plus a new SeaImagine editorial cover. Reference images are inputs, not video outputs.
...
You can experiment, but English is the only officially fully evaluated language. For production, keep shot, movement, and continuity control in English; lock dialogue and on-screen text verbatim in the target language; then approve each locale as a separate 360p draft.
