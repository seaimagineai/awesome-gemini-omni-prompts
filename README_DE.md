...
**76 vollständige Prompts in 9 Kategorien, 9 Beispiele mit eigenen Startbildern und veröffentlichte Ergebnisse samt öffentlichen Prompts der Urheber.**
...
[Nach Kategorie durchsuchen](#prompt-collections) · [Neun Beispiele zum direkten Kopieren](#source-examples) · [Offizielle Ergebnisse und Community-Beispiele](#video-studies) · [Verzeichnis aller 76 Prompts](docs/prompt-index.md) · [Alle Prompts als Text herunterladen](prompts/copy/all-prompts.txt)
...
<table width="100%">
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/cinematic-storytelling.md">Film und Erzählung</a></strong><br><br><a href="prompts/cinematic-storytelling.md"><img src="assets/category-cinema-v3.png" alt="Film und Erzählung" width="100%"></a><br>8 Prompts<br><a href="prompts/cinematic-storytelling.md#case-index">Ansehen</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/commerce-social.md">Werbung und soziale Medien</a></strong><br><br><a href="prompts/commerce-social.md"><img src="assets/category-commerce-v3.png" alt="Werbung und soziale Medien" width="100%"></a><br>8 Prompts<br><a href="prompts/commerce-social.md#case-index">Ansehen</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/documentary-education.md">Dokumentation, Reisen und Bildung</a></strong><br><br><a href="prompts/documentary-education.md"><img src="assets/category-documentary-v3.png" alt="Dokumentation, Reisen und Bildung" width="100%"></a><br>8 Prompts<br><a href="prompts/documentary-education.md#case-index">Ansehen</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/stylized-entertainment.md">Animation, Musik und Unterhaltung</a></strong><br><br><a href="prompts/stylized-entertainment.md"><img src="assets/category-animation-v3.png" alt="Animation, Musik und Unterhaltung" width="100%"></a><br>8 Prompts<br><a href="prompts/stylized-entertainment.md#case-index">Ansehen</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/control-editing-extension.md">Multimodale Steuerung, Schnitt und Verlängerung</a></strong><br><br><a href="prompts/control-editing-extension.md"><img src="assets/category-control-v2.png" alt="Multimodale Steuerung, Schnitt und Verlängerung" width="100%"></a><br>10 Prompts<br><a href="prompts/control-editing-extension.md#case-index">Ansehen</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/advanced-editing-camera.md">Erweiterte Bearbeitung, Kamera und Bildwandel</a></strong><br><br><a href="prompts/advanced-editing-camera.md"><img src="assets/category-camera-v2.png" alt="Erweiterte Bearbeitung, Kamera und Bildwandel" width="100%"></a><br>9 Prompts<br><a href="prompts/advanced-editing-camera.md#case-index">Ansehen</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/storyboard-text-evaluation.md">Storyboards, Text und Bewertung</a></strong><br><br><a href="prompts/storyboard-text-evaluation.md"><img src="assets/category-storyboard-v2.png" alt="Storyboards, Text und Bewertung" width="100%"></a><br>9 Prompts<br><a href="prompts/storyboard-text-evaluation.md#case-index">Ansehen</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/tactile-asmr.md">Materialgefühl und ASMR</a></strong><br><br><a href="prompts/tactile-asmr.md"><img src="assets/category-asmr-v3.png" alt="Materialgefühl und ASMR" width="100%"></a><br>8 Prompts<br><a href="prompts/tactile-asmr.md#case-index">Ansehen</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/miniature-worlds.md">Miniatur- und Fantasiewelten</a></strong><br><br><a href="prompts/miniature-worlds.md"><img src="assets/category-miniature-v3.png" alt="Miniatur- und Fantasiewelten" width="100%"></a><br>8 Prompts<br><a href="prompts/miniature-worlds.md#case-index">Ansehen</a></td>
</tr>
</table>

Kategoriebilder veranschaulichen die Themen. Die neun Beispielbilder dienen als Referenz für den ersten Frame. Keines davon zeigt ein erzeugtes Videoergebnis.

[Verzeichnis aller 76 Prompts](docs/prompt-index.md) · [Alle Prompts als Text herunterladen](prompts/copy/all-prompts.txt) · [Ideenquellen für die neuen Kategorien](docs/public-prompt-sources.md#category-inspiration)

Die Kategoriebeschreibungen sind derzeit auf Chinesisch und Englisch; alle vollständig kopierbaren Prompts sind auf Englisch.

<a id="source-examples"></a>

## Neun Beispiele zum direkten Kopieren

Die Referenzbilder sind Eingabematerial, keine generierten Ergebnisse.

[01 · Der Waschsalon vergisst die Schwerkraft](#example-01) · [02 · Bernsteinparfüm und mechanische Finsternis](#example-02) · [03 · Unter der Wasserlinie der Mangroven](#example-03) · [04 · Der Fuchs bringt den letzten Brief](#example-04) · [05 · Bernsteinglasbirne mit Stern im Kern](#example-05) · [06 · Eine Sternwarte im Koffer](#example-06) · [07 · Buchladenfenster: Winter nur draußen](#example-07) · [08 · Meteoritensaal: eine Kamerafahrt mit Parallaxe](#example-08) · [09 · Unterwasserruinen: Der Roboter bringt einen Lichtsamen zurück](#example-09)

<a id="example-01"></a>

### 01 · Der Waschsalon vergisst die Schwerkraft

[![Der Waschsalon vergisst die Schwerkraft](assets/showcase-v2-01.png)](assets/showcase-v2-01.png)

[Film und Erzählung](prompts/cinematic-storytelling.md) · [Referenz für das erste Bild](assets/showcase-v2-01.png) · [Klartext](prompts/copy/showcase-v2-01.txt)
...
### 02 · Bernsteinparfüm und mechanische Finsternis

[![Bernsteinparfüm und mechanische Finsternis](assets/showcase-v2-02.png)](assets/showcase-v2-02.png)

[Werbung und soziale Medien](prompts/commerce-social.md) · [Referenz für das erste Bild](assets/showcase-v2-02.png) · [Klartext](prompts/copy/showcase-v2-02.txt)
...
### 03 · Unter der Wasserlinie der Mangroven

[![Unter der Wasserlinie der Mangroven](assets/showcase-v2-03.png)](assets/showcase-v2-03.png)

[Dokumentation, Reisen und Bildung](prompts/documentary-education.md) · [Referenz für das erste Bild](assets/showcase-v2-03.png) · [Klartext](prompts/copy/showcase-v2-03.txt)
...
### 04 · Der Fuchs bringt den letzten Brief

[![Der Fuchs bringt den letzten Brief](assets/showcase-v2-04.png)](assets/showcase-v2-04.png)

[Animation, Musik und Unterhaltung](prompts/stylized-entertainment.md) · [Referenz für das erste Bild](assets/showcase-v2-04.png) · [Klartext](prompts/copy/showcase-v2-04.txt)
...
### 05 · Bernsteinglasbirne mit Stern im Kern

[![Bernsteinglasbirne mit Stern im Kern](assets/showcase-v2-05.png)](assets/showcase-v2-05.png)

[Materialgefühl und ASMR](prompts/tactile-asmr.md) · [Referenz für das erste Bild](assets/showcase-v2-05.png) · [Klartext](prompts/copy/showcase-v2-05.txt)
...
### 06 · Eine Sternwarte im Koffer

[![Eine Sternwarte im Koffer](assets/showcase-v2-06.png)](assets/showcase-v2-06.png)

[Miniatur- und Fantasiewelten](prompts/miniature-worlds.md) · [Referenz für das erste Bild](assets/showcase-v2-06.png) · [Klartext](prompts/copy/showcase-v2-06.txt)
...
### 07 · Buchladenfenster: Winter nur draußen

[![Buchladenfenster: Winter nur draußen](assets/showcase-v3-07.png)](assets/showcase-v3-07.png)

[Multimodale Steuerung, Schnitt und Verlängerung](prompts/control-editing-extension.md) · [Referenz für das erste Bild](assets/showcase-v3-07.png) · [Klartext](prompts/copy/showcase-v3-07.txt)
...
### 08 · Meteoritensaal: eine Kamerafahrt mit Parallaxe

[![Meteoritensaal: eine Kamerafahrt mit Parallaxe](assets/showcase-v3-08.png)](assets/showcase-v3-08.png)

[Erweiterte Bearbeitung, Kamera und Bildwandel](prompts/advanced-editing-camera.md) · [Referenz für das erste Bild](assets/showcase-v3-08.png) · [Klartext](prompts/copy/showcase-v3-08.txt)
...
### 09 · Unterwasserruinen: Der Roboter bringt einen Lichtsamen zurück

[![Unterwasserruinen: Der Roboter bringt einen Lichtsamen zurück](assets/showcase-v3-09.png)](assets/showcase-v3-09.png)

[Storyboards, Text und Bewertung](prompts/storyboard-text-evaluation.md) · [Referenz für das erste Bild](assets/showcase-v3-09.png) · [Klartext](prompts/copy/showcase-v3-09.txt)
...
## Offizielle Ergebnisse und Community-Beispiele

Jedes Ergebnis verlinkt den Originalprompt. X-Texte wurden über einen Spiegel geprüft, nicht die Wiedergabe auf X. Die Modellversion steht in der jeweiligen Quelle; dieser Bestand hat die Ergebnisse nicht nachgestellt.

<table width="100%">
<tr>
<td width="50%" valign="top"><strong>Skulptur aus Seifenblasen</strong><br><a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm__omni__keynote__orb-structural-foam__260517_1.mp4"><img src="assets/official-bubbles-link.svg" alt="Offizielles Video · kein Vorschaubild" width="100%"></a><br>Google · Omni / Flash · 2026-05<br>Eingabevideo erforderlich<br><strong>Auszug aus dem veröffentlichten Prompt</strong><blockquote>Make the sculpture out of bubbles.</blockquote><a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Veröffentlichter Prompt des Urhebers</a> · <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm__omni__keynote__orb-structural-foam__260517_1.mp4">Video ansehen</a> · <a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Quelle</a></td>
<td width="50%" valign="top"><strong>Ein Zimmer in einer Glaskugel</strong><br><a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm_omni__keynote__sizzle__hand-infinite-orbs__260517_1.mp4"><img src="assets/official-recursive-link.svg" alt="Offizielles Video · kein Vorschaubild" width="100%"></a><br>Google · Omni / Flash · 2026-05<br>Eingabevideo erforderlich<br><strong>Auszug aus dem veröffentlichten Prompt</strong><blockquote>Put a black and white checkerboard room inside a glass sphere</blockquote><a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Veröffentlichter Prompt des Urhebers</a> · <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm_omni__keynote__sizzle__hand-infinite-orbs__260517_1.mp4">Video ansehen</a> · <a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Quelle</a></td>
</tr>
<tr>
<td width="50%" valign="top"><strong>Menschen in Flamingos verwandeln</strong><br><a href="https://video.twimg.com/amplify_video/2056797343085969408/vid/avc1/1080x1440/UYr_7RKomiginRgq.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056797343085969408/img/o5L2FQvozlZtiFsK.jpg" alt="Menschen in Flamingos verwandeln" width="100%"></a><br>CHRIS FIRST · Omni / Flash · 2026-05<br>Eingabevideo erforderlich<br><strong>Auszug aus dem veröffentlichten Prompt</strong><blockquote>Make everyone in this shot flamingos. Wearing the same outfit.</blockquote><a href="https://x.com/chrisfirst/status/2056797606509158681">Veröffentlichter Prompt des Urhebers</a> · <a href="https://video.twimg.com/amplify_video/2056797343085969408/vid/avc1/1080x1440/UYr_7RKomiginRgq.mp4?tag=27">Video ansehen</a> · <a href="https://x.com/chrisfirst/status/2056797606509158681">Quelle</a></td>
<td width="50%" valign="top"><strong>Bei jedem Klatschen den Hut wechseln</strong><br><a href="https://video.twimg.com/amplify_video/2056793760273686528/vid/avc1/720x1280/Q73liRfIjPtGSveL.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056793760273686528/img/tZQnlGWzgr5wOwnM.jpg" alt="Bei jedem Klatschen den Hut wechseln" width="100%"></a><br>Justine Moore · Omni / Flash · 2026-05<br>Eingabevideo erforderlich<br><strong>Auszug aus dem veröffentlichten Prompt</strong><blockquote>change my hat every time I clap.</blockquote><a href="https://x.com/venturetwins/status/2056793856843366789">Veröffentlichter Prompt des Urhebers</a> · <a href="https://video.twimg.com/amplify_video/2056793760273686528/vid/avc1/720x1280/Q73liRfIjPtGSveL.mp4?tag=27">Video ansehen</a> · <a href="https://x.com/venturetwins/status/2056793856843366789">Quelle</a></td>
</tr>
<tr>
<td width="50%" valign="top"><strong>Handgeführter Zoom aus dem London Eye</strong><br><a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056503814874861569/img/mQnHwThYDypoS1H6.jpg" alt="Handgeführter Zoom aus dem London Eye" width="100%"></a><br>fofr · Omni / Flash · 2026-05<br>Text zu Video<br><strong>Auszug aus dem veröffentlichten Prompt</strong><blockquote>a recording from a capsule on the london eye, a jerky zoom into something in the distance</blockquote><a href="https://x.com/fofrAI/status/2056789242274259242">Veröffentlichter Prompt des Urhebers</a> · <a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27">Video ansehen</a> · <a href="https://x.com/fofrAI/status/2056789242274259242">Quelle</a></td>
<td width="50%" valign="top"><strong>Materialwechsel einer Kanne bei Berührung</strong><br><a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2057176000459612161/img/wTZ0HcgL_8PHxwbY.jpg" alt="Materialwechsel einer Kanne bei Berührung" width="100%"></a><br>Alexander Chen · Omni / Flash · 2026-05<br>Eingabevideo erforderlich<br><strong>Auszug aus dem veröffentlichten Prompt</strong><blockquote>make the material of the pitcher instantly change (hard cuts) every 1 seconds to a new material</blockquote><a href="https://x.com/alexanderchen/status/2057176691903279524">Veröffentlichter Prompt des Urhebers</a> · <a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27">Video ansehen</a> · <a href="https://x.com/alexanderchen/status/2057176690519089166">Quelle</a></td>
</tr>
</table>

[Quelle / FxTwitter](docs/public-prompt-sources.md)

## Weiterführende Dokumentation

Für erfahrene Nutzer: Referenzen eindeutig zuordnen, Abläufe planen und jeweils nur einen Aspekt ändern.

1. Objektzahl, Positionen und Ausgangszustand müssen zum Startbild passen.
2. Je Zeitabschnitt eine Hauptbewegung vorsehen und den Ton auf den sichtbaren Auslöser abstimmen.
3. Das Motiv erhalten und nur Kamera oder Material ändern; Zeitabschnitte an die unterstützte Videolänge anpassen.

Wiederverwendbare Anweisung für eine einzelne Änderung — sofern das Modell Bearbeitung unterstützt
...
[Weiterführende Dokumentation](docs/guides/README_DE.md)

[Prompts entwerfen](docs/prompting-guide.md) · [Mehrsprachiger Leitfaden](docs/multilingual-guide.md) · [Referenzmaterial und Rechte](docs/reference-videos.md)
...
1. Startbild herunterladen, in Bild-zu-Video hochladen und den vollständigen Prompt einfügen.
2. Länge, Seitenverhältnis und Auflösung aus den Modelloptionen wählen; zunächst einen Entwurf erzeugen.
3. Wenn die Komposition passt, jeweils ein Detail ändern und erst danach die Auflösung erhöhen.

[Gemini Omni 1.1 Flash](https://seaimagine.com/de/model/gemini-omni-1-1-flash/) · [Gemini Omni](https://seaimagine.com/de/model/gemini-omni/)

[Bild zu Video](https://seaimagine.com/de/image-to-video/) · [Text zu Video](https://seaimagine.com/de/text-to-video/) · [KI-Bildgenerator](https://seaimagine.com/de/ai-image-generator/)
