...
**76 полных промптов в 9 категориях, 9 примеров с оригинальными стартовыми кадрами и опубликованные результаты со ссылками на промпты авторов.**
...
[Поиск по категориям](#prompt-collections) · [Девять примеров для копирования](#source-examples) · [Официальные примеры и результаты сообщества](#video-studies) · [Указатель всех 76 промптов](docs/prompt-index.md) · [Скачать все промпты в текстовом формате](prompts/copy/all-prompts.txt)
...
<table width="100%">
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/cinematic-storytelling.md">Кино и повествование</a></strong><br><br><a href="prompts/cinematic-storytelling.md"><img src="assets/category-cinema-v3.png" alt="Кино и повествование" width="100%"></a><br>8 промптов<br><a href="prompts/cinematic-storytelling.md#case-index">Открыть</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/commerce-social.md">Реклама и соцсети</a></strong><br><br><a href="prompts/commerce-social.md"><img src="assets/category-commerce-v3.png" alt="Реклама и соцсети" width="100%"></a><br>8 промптов<br><a href="prompts/commerce-social.md#case-index">Открыть</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/documentary-education.md">Документалистика, путешествия и образование</a></strong><br><br><a href="prompts/documentary-education.md"><img src="assets/category-documentary-v3.png" alt="Документалистика, путешествия и образование" width="100%"></a><br>8 промптов<br><a href="prompts/documentary-education.md#case-index">Открыть</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/stylized-entertainment.md">Анимация, музыка и развлечения</a></strong><br><br><a href="prompts/stylized-entertainment.md"><img src="assets/category-animation-v3.png" alt="Анимация, музыка и развлечения" width="100%"></a><br>8 промптов<br><a href="prompts/stylized-entertainment.md#case-index">Открыть</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/control-editing-extension.md">Мультимодальное управление, монтаж и продление</a></strong><br><br><a href="prompts/control-editing-extension.md"><img src="assets/category-control-v2.png" alt="Мультимодальное управление, монтаж и продление" width="100%"></a><br>10 промптов<br><a href="prompts/control-editing-extension.md#case-index">Открыть</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/advanced-editing-camera.md">Продвинутый монтаж, камера и визуальные изменения</a></strong><br><br><a href="prompts/advanced-editing-camera.md"><img src="assets/category-camera-v2.png" alt="Продвинутый монтаж, камера и визуальные изменения" width="100%"></a><br>9 промптов<br><a href="prompts/advanced-editing-camera.md#case-index">Открыть</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/storyboard-text-evaluation.md">Раскадровка, текст и оценка</a></strong><br><br><a href="prompts/storyboard-text-evaluation.md"><img src="assets/category-storyboard-v2.png" alt="Раскадровка, текст и оценка" width="100%"></a><br>9 промптов<br><a href="prompts/storyboard-text-evaluation.md#case-index">Открыть</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/tactile-asmr.md">Фактуры и ASMR</a></strong><br><br><a href="prompts/tactile-asmr.md"><img src="assets/category-asmr-v3.png" alt="Фактуры и ASMR" width="100%"></a><br>8 промптов<br><a href="prompts/tactile-asmr.md#case-index">Открыть</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/miniature-worlds.md">Миниатюрные и фантастические миры</a></strong><br><br><a href="prompts/miniature-worlds.md"><img src="assets/category-miniature-v3.png" alt="Миниатюрные и фантастические миры" width="100%"></a><br>8 промптов<br><a href="prompts/miniature-worlds.md#case-index">Открыть</a></td>
</tr>
</table>

Изображения категорий иллюстрируют темы. Девять изображений примеров служат референсами для стартового кадра. Ни те ни другие не показывают результаты генерации видео.

[Указатель всех 76 промптов](docs/prompt-index.md) · [Скачать все промпты в текстовом формате](prompts/copy/all-prompts.txt) · [Источники идей для новых категорий](docs/public-prompt-sources.md#category-inspiration)

Описания категорий пока доступны на китайском и английском; все полные промпты для копирования написаны на английском.

<a id="source-examples"></a>

## Девять примеров для копирования

Референсные изображения — это входные материалы, а не результаты генерации.

[01 · Прачечная без гравитации](#example-01) · [02 · Янтарные духи и механическое затмение](#example-02) · [03 · Под водой мангрового леса](#example-03) · [04 · Лис доставляет последнее письмо](#example-04) · [05 · Стеклянная груша со звёздным ядром](#example-05) · [06 · Обсерватория в чемодане](#example-06) · [07 · Окно книжного магазина: зима только снаружи](#example-07) · [08 · Зал метеоритов: облёт с параллаксом](#example-08) · [09 · Подводные руины: робот возвращает семя света](#example-09)

<a id="example-01"></a>

### 01 · Прачечная без гравитации

[![Прачечная без гравитации](assets/showcase-v2-01.png)](assets/showcase-v2-01.png)

[Кино и повествование](prompts/cinematic-storytelling.md) · [Референс первого кадра](assets/showcase-v2-01.png) · [Обычный текст](prompts/copy/showcase-v2-01.txt)
...
### 02 · Янтарные духи и механическое затмение

[![Янтарные духи и механическое затмение](assets/showcase-v2-02.png)](assets/showcase-v2-02.png)

[Реклама и соцсети](prompts/commerce-social.md) · [Референс первого кадра](assets/showcase-v2-02.png) · [Обычный текст](prompts/copy/showcase-v2-02.txt)
...
### 03 · Под водой мангрового леса

[![Под водой мангрового леса](assets/showcase-v2-03.png)](assets/showcase-v2-03.png)

[Документалистика, путешествия и образование](prompts/documentary-education.md) · [Референс первого кадра](assets/showcase-v2-03.png) · [Обычный текст](prompts/copy/showcase-v2-03.txt)
...
### 04 · Лис доставляет последнее письмо

[![Лис доставляет последнее письмо](assets/showcase-v2-04.png)](assets/showcase-v2-04.png)

[Анимация, музыка и развлечения](prompts/stylized-entertainment.md) · [Референс первого кадра](assets/showcase-v2-04.png) · [Обычный текст](prompts/copy/showcase-v2-04.txt)
...
### 05 · Стеклянная груша со звёздным ядром

[![Стеклянная груша со звёздным ядром](assets/showcase-v2-05.png)](assets/showcase-v2-05.png)

[Фактуры и ASMR](prompts/tactile-asmr.md) · [Референс первого кадра](assets/showcase-v2-05.png) · [Обычный текст](prompts/copy/showcase-v2-05.txt)
...
### 06 · Обсерватория в чемодане

[![Обсерватория в чемодане](assets/showcase-v2-06.png)](assets/showcase-v2-06.png)

[Миниатюрные и фантастические миры](prompts/miniature-worlds.md) · [Референс первого кадра](assets/showcase-v2-06.png) · [Обычный текст](prompts/copy/showcase-v2-06.txt)
...
### 07 · Окно книжного магазина: зима только снаружи

[![Окно книжного магазина: зима только снаружи](assets/showcase-v3-07.png)](assets/showcase-v3-07.png)

[Мультимодальное управление, монтаж и продление](prompts/control-editing-extension.md) · [Референс первого кадра](assets/showcase-v3-07.png) · [Обычный текст](prompts/copy/showcase-v3-07.txt)
...
### 08 · Зал метеоритов: облёт с параллаксом

[![Зал метеоритов: облёт с параллаксом](assets/showcase-v3-08.png)](assets/showcase-v3-08.png)

[Продвинутый монтаж, камера и визуальные изменения](prompts/advanced-editing-camera.md) · [Референс первого кадра](assets/showcase-v3-08.png) · [Обычный текст](prompts/copy/showcase-v3-08.txt)
...
### 09 · Подводные руины: робот возвращает семя света

[![Подводные руины: робот возвращает семя света](assets/showcase-v3-09.png)](assets/showcase-v3-09.png)

[Раскадровка, текст и оценка](prompts/storyboard-text-evaluation.md) · [Референс первого кадра](assets/showcase-v3-09.png) · [Обычный текст](prompts/copy/showcase-v3-09.txt)
...
## Официальные примеры и результаты сообщества

У каждого результата есть ссылка на исходный промпт. Тексты X проверены через зеркало; воспроизведение на самом X не проверялось. Версия модели указана в источнике. Это не результаты воспроизведения в данном репозитории.

<table width="100%">
<tr>
<td width="50%" valign="top"><strong>Скульптура из пузырей</strong><br><a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm__omni__keynote__orb-structural-foam__260517_1.mp4"><img src="assets/official-bubbles-link.svg" alt="Официальное видео · без миниатюры" width="100%"></a><br>Google · Omni / Flash · 2026-05<br>Нужно входное видео<br><strong>Отрывок опубликованного промпта</strong><blockquote>Make the sculpture out of bubbles.</blockquote><a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Промпт, опубликованный автором</a> · <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm__omni__keynote__orb-structural-foam__260517_1.mp4">Смотреть видео</a> · <a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Источник</a></td>
<td width="50%" valign="top"><strong>Комната внутри стеклянной сферы</strong><br><a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm_omni__keynote__sizzle__hand-infinite-orbs__260517_1.mp4"><img src="assets/official-recursive-link.svg" alt="Официальное видео · без миниатюры" width="100%"></a><br>Google · Omni / Flash · 2026-05<br>Нужно входное видео<br><strong>Отрывок опубликованного промпта</strong><blockquote>Put a black and white checkerboard room inside a glass sphere</blockquote><a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Промпт, опубликованный автором</a> · <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm_omni__keynote__sizzle__hand-infinite-orbs__260517_1.mp4">Смотреть видео</a> · <a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Источник</a></td>
</tr>
<tr>
<td width="50%" valign="top"><strong>Заменить людей фламинго</strong><br><a href="https://video.twimg.com/amplify_video/2056797343085969408/vid/avc1/1080x1440/UYr_7RKomiginRgq.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056797343085969408/img/o5L2FQvozlZtiFsK.jpg" alt="Заменить людей фламинго" width="100%"></a><br>CHRIS FIRST · Omni / Flash · 2026-05<br>Нужно входное видео<br><strong>Отрывок опубликованного промпта</strong><blockquote>Make everyone in this shot flamingos. Wearing the same outfit.</blockquote><a href="https://x.com/chrisfirst/status/2056797606509158681">Промпт, опубликованный автором</a> · <a href="https://video.twimg.com/amplify_video/2056797343085969408/vid/avc1/1080x1440/UYr_7RKomiginRgq.mp4?tag=27">Смотреть видео</a> · <a href="https://x.com/chrisfirst/status/2056797606509158681">Источник</a></td>
<td width="50%" valign="top"><strong>Менять шляпу при каждом хлопке</strong><br><a href="https://video.twimg.com/amplify_video/2056793760273686528/vid/avc1/720x1280/Q73liRfIjPtGSveL.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056793760273686528/img/tZQnlGWzgr5wOwnM.jpg" alt="Менять шляпу при каждом хлопке" width="100%"></a><br>Justine Moore · Omni / Flash · 2026-05<br>Нужно входное видео<br><strong>Отрывок опубликованного промпта</strong><blockquote>change my hat every time I clap.</blockquote><a href="https://x.com/venturetwins/status/2056793856843366789">Промпт, опубликованный автором</a> · <a href="https://video.twimg.com/amplify_video/2056793760273686528/vid/avc1/720x1280/Q73liRfIjPtGSveL.mp4?tag=27">Смотреть видео</a> · <a href="https://x.com/venturetwins/status/2056793856843366789">Источник</a></td>
</tr>
<tr>
<td width="50%" valign="top"><strong>Ручной зум из кабины London Eye</strong><br><a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056503814874861569/img/mQnHwThYDypoS1H6.jpg" alt="Ручной зум из кабины London Eye" width="100%"></a><br>fofr · Omni / Flash · 2026-05<br>Видео из текста<br><strong>Отрывок опубликованного промпта</strong><blockquote>a recording from a capsule on the london eye, a jerky zoom into something in the distance</blockquote><a href="https://x.com/fofrAI/status/2056789242274259242">Промпт, опубликованный автором</a> · <a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27">Смотреть видео</a> · <a href="https://x.com/fofrAI/status/2056789242274259242">Источник</a></td>
<td width="50%" valign="top"><strong>Менять материал кувшина при касании</strong><br><a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2057176000459612161/img/wTZ0HcgL_8PHxwbY.jpg" alt="Менять материал кувшина при касании" width="100%"></a><br>Alexander Chen · Omni / Flash · 2026-05<br>Нужно входное видео<br><strong>Отрывок опубликованного промпта</strong><blockquote>make the material of the pitcher instantly change (hard cuts) every 1 seconds to a new material</blockquote><a href="https://x.com/alexanderchen/status/2057176691903279524">Промпт, опубликованный автором</a> · <a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27">Смотреть видео</a> · <a href="https://x.com/alexanderchen/status/2057176690519089166">Источник</a></td>
</tr>
</table>

[Источник / FxTwitter](docs/public-prompt-sources.md)

## Дополнительная документация

Для опытных пользователей: уточняйте роли референсов, время действий и меняйте по одному параметру.

1. Число объектов, их положение и исходное состояние должны совпадать со стартовым кадром.
2. Задавайте одно основное движение на интервал и привязывайте звук к видимому событию.
3. Сохраняйте главный объект, меняя только камеру или материал; подстройте интервалы под поддерживаемую длительность.

Готовая инструкция для одного изменения — если модель поддерживает редактирование
...
[Дополнительная документация](docs/guides/README_RU.md)

[Составление промптов](docs/prompting-guide.md) · [Многоязычное руководство](docs/multilingual-guide.md) · [Референсы и разрешения](docs/reference-videos.md)

<a id="brand-tools"></a>

## Создать в SeaImagine

<a href="https://seaimagine.com/ru/"><img src="assets/seaimagine-logo.png" alt="SeaImagine" width="48"></a>

[![Создать в SeaImagine](assets/seaimagine-creative-world.png)](https://seaimagine.com/ru/image-to-video/)

Хотите свою версию стеклянной груши или мира в чемодане? Начните с референсного изображения в SeaImagine, вставьте полный промпт из библиотеки и измените объект, материалы и камеру под свой замысел.

Нет подходящего стартового изображения? Подготовьте сцену с помощью генерации изображений ИИ. Если изображение уже есть, переходите к созданию видео из него. Выберите тему из библиотеки и переработайте её, сохраняя временную последовательность и детали, которые не должны меняться.

1. Скачайте стартовый кадр, загрузите его в режим видео из изображения и вставьте полный промпт.
2. Выберите доступные для модели длительность, формат и разрешение; сначала сделайте черновик.
3. Когда композиция устроит, меняйте по одной детали, затем повышайте разрешение.

[Gemini Omni 1.1 Flash](https://seaimagine.com/ru/model/gemini-omni-1-1-flash/) · [Gemini Omni](https://seaimagine.com/ru/model/gemini-omni/)

[Видео из изображения](https://seaimagine.com/ru/image-to-video/) · [Видео из текста](https://seaimagine.com/ru/text-to-video/) · [Генератор изображений ИИ](https://seaimagine.com/ru/ai-image-generator/)
