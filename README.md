...
![Gemini Omni Prompt Library](assets/seaimagine-omni-hero.png)

# Gemini Omni Prompt Library

**76 complete prompts in 9 categories, 9 original starting-frame examples, and published results paired with their authors’ public prompts.**
...
[Browse by category](#prompt-collections) · [Nine ready-to-copy examples](#source-examples) · [Official and community results](#video-studies) · [Index of all 76 prompts](docs/prompt-index.md) · [Download all prompts as text](prompts/copy/all-prompts.txt)
...
<table width="100%">
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/cinematic-storytelling.md">Cinema and storytelling</a></strong><br><br><a href="prompts/cinematic-storytelling.md"><img src="assets/category-cinema-v3.png" alt="Cinema and storytelling" width="100%"></a><br>8 prompts<br><a href="prompts/cinematic-storytelling.md#case-index">View</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/commerce-social.md">Commerce and social media</a></strong><br><br><a href="prompts/commerce-social.md"><img src="assets/category-commerce-v3.png" alt="Commerce and social media" width="100%"></a><br>8 prompts<br><a href="prompts/commerce-social.md#case-index">View</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/documentary-education.md">Documentary, travel and education</a></strong><br><br><a href="prompts/documentary-education.md"><img src="assets/category-documentary-v3.png" alt="Documentary, travel and education" width="100%"></a><br>8 prompts<br><a href="prompts/documentary-education.md#case-index">View</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/stylized-entertainment.md">Animation, music and entertainment</a></strong><br><br><a href="prompts/stylized-entertainment.md"><img src="assets/category-animation-v3.png" alt="Animation, music and entertainment" width="100%"></a><br>8 prompts<br><a href="prompts/stylized-entertainment.md#case-index">View</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/control-editing-extension.md">Control, editing and extension</a></strong><br><br><a href="prompts/control-editing-extension.md"><img src="assets/category-control-v2.png" alt="Control, editing and extension" width="100%"></a><br>10 prompts<br><a href="prompts/control-editing-extension.md#case-index">View</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/advanced-editing-camera.md">Advanced editing and camera</a></strong><br><br><a href="prompts/advanced-editing-camera.md"><img src="assets/category-camera-v2.png" alt="Advanced editing and camera" width="100%"></a><br>9 prompts<br><a href="prompts/advanced-editing-camera.md#case-index">View</a></td>
</tr>
<tr>
<td width="33%" align="center" valign="top"><strong><a href="prompts/storyboard-text-evaluation.md">Storyboards, text and evaluation</a></strong><br><br><a href="prompts/storyboard-text-evaluation.md"><img src="assets/category-storyboard-v2.png" alt="Storyboards, text and evaluation" width="100%"></a><br>9 prompts<br><a href="prompts/storyboard-text-evaluation.md#case-index">View</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/tactile-asmr.md">Tactile ASMR</a></strong><br><br><a href="prompts/tactile-asmr.md"><img src="assets/category-asmr-v3.png" alt="Tactile ASMR" width="100%"></a><br>8 prompts<br><a href="prompts/tactile-asmr.md#case-index">View</a></td>
<td width="33%" align="center" valign="top"><strong><a href="prompts/miniature-worlds.md">Miniature and imagined worlds</a></strong><br><br><a href="prompts/miniature-worlds.md"><img src="assets/category-miniature-v3.png" alt="Miniature and imagined worlds" width="100%"></a><br>8 prompts<br><a href="prompts/miniature-worlds.md#case-index">View</a></td>
</tr>
</table>

Category images illustrate their themes. The nine example images are reference starting frames. Neither represents a generated video result.

[Index of all 76 prompts](docs/prompt-index.md) · [Download all prompts as text](prompts/copy/all-prompts.txt) · [Creative sources for the new categories](docs/public-prompt-sources.md#category-inspiration)

Category descriptions are currently in Chinese and English; all complete, copyable prompts are in English.

<a id="source-examples"></a>

## Nine ready-to-copy examples

The reference images are input assets, not generated results.

[01 · The laundromat forgets gravity](#example-01) · [02 · Amber perfume / mechanical eclipse](#example-02) · [03 · Below the mangrove waterline](#example-03) · [04 · The fox delivers the last letter](#example-04) · [05 · Amber glass pear / star-core cut](#example-05) · [06 · An observatory inside a suitcase](#example-06) · [07 · Bookshop window: winter outside only](#example-07) · [08 · Meteorite gallery: a parallax orbit](#example-08) · [09 · Underwater ruins: the robot returns a light seed](#example-09)

<a id="example-01"></a>

### 01 · The laundromat forgets gravity

[![The laundromat forgets gravity](assets/showcase-v2-01.png)](assets/showcase-v2-01.png)

[Cinema and storytelling](prompts/cinematic-storytelling.md) · [Reference first frame](assets/showcase-v2-01.png) · [Plain text](prompts/copy/showcase-v2-01.txt)
...
### 02 · Amber perfume / mechanical eclipse

[![Amber perfume / mechanical eclipse](assets/showcase-v2-02.png)](assets/showcase-v2-02.png)

[Commerce and social media](prompts/commerce-social.md) · [Reference first frame](assets/showcase-v2-02.png) · [Plain text](prompts/copy/showcase-v2-02.txt)
...
### 03 · Below the mangrove waterline

[![Below the mangrove waterline](assets/showcase-v2-03.png)](assets/showcase-v2-03.png)

[Documentary, travel and education](prompts/documentary-education.md) · [Reference first frame](assets/showcase-v2-03.png) · [Plain text](prompts/copy/showcase-v2-03.txt)
...
### 04 · The fox delivers the last letter

[![The fox delivers the last letter](assets/showcase-v2-04.png)](assets/showcase-v2-04.png)

[Animation, music and entertainment](prompts/stylized-entertainment.md) · [Reference first frame](assets/showcase-v2-04.png) · [Plain text](prompts/copy/showcase-v2-04.txt)
...
### 05 · Amber glass pear / star-core cut

[![Amber glass pear / star-core cut](assets/showcase-v2-05.png)](assets/showcase-v2-05.png)

[Tactile ASMR](prompts/tactile-asmr.md) · [Reference first frame](assets/showcase-v2-05.png) · [Plain text](prompts/copy/showcase-v2-05.txt)
...
### 06 · An observatory inside a suitcase

[![An observatory inside a suitcase](assets/showcase-v2-06.png)](assets/showcase-v2-06.png)

[Miniature and imagined worlds](prompts/miniature-worlds.md) · [Reference first frame](assets/showcase-v2-06.png) · [Plain text](prompts/copy/showcase-v2-06.txt)
...
### 07 · Bookshop window: winter outside only

[![Bookshop window: winter outside only](assets/showcase-v3-07.png)](assets/showcase-v3-07.png)

[Control, editing and extension](prompts/control-editing-extension.md) · [Reference first frame](assets/showcase-v3-07.png) · [Plain text](prompts/copy/showcase-v3-07.txt)
...
### 08 · Meteorite gallery: a parallax orbit

[![Meteorite gallery: a parallax orbit](assets/showcase-v3-08.png)](assets/showcase-v3-08.png)

[Advanced editing and camera](prompts/advanced-editing-camera.md) · [Reference first frame](assets/showcase-v3-08.png) · [Plain text](prompts/copy/showcase-v3-08.txt)
...
### 09 · Underwater ruins: the robot returns a light seed

[![Underwater ruins: the robot returns a light seed](assets/showcase-v3-09.png)](assets/showcase-v3-09.png)

[Storyboards, text and evaluation](prompts/storyboard-text-evaluation.md) · [Reference first frame](assets/showcase-v3-09.png) · [Plain text](prompts/copy/showcase-v3-09.txt)
...
Every result links to its published prompt. X text was checked through a mirror, without native playback verification. Consult each source for the model version; these are not reproductions made by this repository.

<table width="100%">
<tr>
<td width="50%" valign="top"><strong>Bubble sculpture</strong><br><a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm__omni__keynote__orb-structural-foam__260517_1.mp4"><img src="assets/official-bubbles-link.svg" alt="Official video · no thumbnail" width="100%"></a><br>Google · Omni / Flash · 2026-05<br>Input video required<br><strong>Published prompt excerpt</strong><blockquote>Make the sculpture out of bubbles.</blockquote><a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Author’s published prompt</a> · <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm__omni__keynote__orb-structural-foam__260517_1.mp4">Watch video</a> · <a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Source</a></td>
<td width="50%" valign="top"><strong>A room inside a glass sphere</strong><br><a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm_omni__keynote__sizzle__hand-infinite-orbs__260517_1.mp4"><img src="assets/official-recursive-link.svg" alt="Official video · no thumbnail" width="100%"></a><br>Google · Omni / Flash · 2026-05<br>Input video required<br><strong>Published prompt excerpt</strong><blockquote>Put a black and white checkerboard room inside a glass sphere</blockquote><a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Author’s published prompt</a> · <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/rt_wm_omni__keynote__sizzle__hand-infinite-orbs__260517_1.mp4">Watch video</a> · <a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-omni-3-5-videos/">Source</a></td>
</tr>
<tr>
<td width="50%" valign="top"><strong>Replace people with flamingos</strong><br><a href="https://video.twimg.com/amplify_video/2056797343085969408/vid/avc1/1080x1440/UYr_7RKomiginRgq.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056797343085969408/img/o5L2FQvozlZtiFsK.jpg" alt="Replace people with flamingos" width="100%"></a><br>CHRIS FIRST · Omni / Flash · 2026-05<br>Input video required<br><strong>Published prompt excerpt</strong><blockquote>Make everyone in this shot flamingos. Wearing the same outfit.</blockquote><a href="https://x.com/chrisfirst/status/2056797606509158681">Author’s published prompt</a> · <a href="https://video.twimg.com/amplify_video/2056797343085969408/vid/avc1/1080x1440/UYr_7RKomiginRgq.mp4?tag=27">Watch video</a> · <a href="https://x.com/chrisfirst/status/2056797606509158681">Source</a></td>
<td width="50%" valign="top"><strong>Change hats on each clap</strong><br><a href="https://video.twimg.com/amplify_video/2056793760273686528/vid/avc1/720x1280/Q73liRfIjPtGSveL.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056793760273686528/img/tZQnlGWzgr5wOwnM.jpg" alt="Change hats on each clap" width="100%"></a><br>Justine Moore · Omni / Flash · 2026-05<br>Input video required<br><strong>Published prompt excerpt</strong><blockquote>change my hat every time I clap.</blockquote><a href="https://x.com/venturetwins/status/2056793856843366789">Author’s published prompt</a> · <a href="https://video.twimg.com/amplify_video/2056793760273686528/vid/avc1/720x1280/Q73liRfIjPtGSveL.mp4?tag=27">Watch video</a> · <a href="https://x.com/venturetwins/status/2056793856843366789">Source</a></td>
</tr>
<tr>
<td width="50%" valign="top"><strong>London Eye handheld zoom</strong><br><a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2056503814874861569/img/mQnHwThYDypoS1H6.jpg" alt="London Eye handheld zoom" width="100%"></a><br>fofr · Omni / Flash · 2026-05<br>Text to video<br><strong>Published prompt excerpt</strong><blockquote>a recording from a capsule on the london eye, a jerky zoom into something in the distance</blockquote><a href="https://x.com/fofrAI/status/2056789242274259242">Author’s published prompt</a> · <a href="https://video.twimg.com/amplify_video/2056503814874861569/vid/avc1/1280x720/Lc2C4YtTflfGA8qe.mp4?tag=27">Watch video</a> · <a href="https://x.com/fofrAI/status/2056789242274259242">Source</a></td>
<td width="50%" valign="top"><strong>Change a pitcher’s material on touch</strong><br><a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27"><img src="https://pbs.twimg.com/amplify_video_thumb/2057176000459612161/img/wTZ0HcgL_8PHxwbY.jpg" alt="Change a pitcher’s material on touch" width="100%"></a><br>Alexander Chen · Omni / Flash · 2026-05<br>Input video required<br><strong>Published prompt excerpt</strong><blockquote>make the material of the pitcher instantly change (hard cuts) every 1 seconds to a new material</blockquote><a href="https://x.com/alexanderchen/status/2057176691903279524">Author’s published prompt</a> · <a href="https://video.twimg.com/amplify_video/2057176000459612161/vid/avc1/1280x720/LRzM8IueMomPMa7J.mp4?tag=27">Watch video</a> · <a href="https://x.com/alexanderchen/status/2057176690519089166">Source</a></td>
</tr>
</table>

[Source / FxTwitter](docs/public-prompt-sources.md)

## Further reading

For experienced users: refine reference roles, action timing and one change at a time.

1. Match the prompt to the starting frame: keep object counts, positions and initial states consistent.
2. Assign one main movement to each time segment and align the sound with its visible trigger.
3. Change only the camera or material while preserving the subject; adapt the timeline to the duration your chosen model supports.

Reusable single-change instruction — if the selected model supports editing
...
[Further reading](docs/guides/README_EN.md)

[Prompt design](docs/prompting-guide.md) · [Multilingual guide](docs/multilingual-guide.md) · [Reference media and permissions](docs/reference-videos.md)
...
1. Download the starting image, upload it to image-to-video, and paste the complete prompt.
2. Choose duration, aspect ratio and resolution from the selected model’s available controls; make a draft first.
3. Once the composition works, change one detail at a time before increasing the resolution.

[Gemini Omni 1.1 Flash](https://seaimagine.com/model/gemini-omni-1-1-flash/) · [Gemini Omni](https://seaimagine.com/model/gemini-omni/)

[Image to video](https://seaimagine.com/image-to-video/) · [Text to video](https://seaimagine.com/text-to-video/) · [AI image generator](https://seaimagine.com/ai-image-generator/)

[SeaImagine workflow](docs/seaimagine-workflow.md)

## Source and licence

Adapted from the Flaq AI repository, including its prompt collection and three reference images. These materials are not all original to SeaImagine. This is an independent guide, not a Google product.
